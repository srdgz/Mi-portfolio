const DownloadCvButton = () => {
  return (
    <a
      ...
      className="inline-block px-4 py-2 text-sm md:text-md text-center font-bold bg-blue-500 text-white rounded-[50px] hover:bg-blue-600 focus:outline-none shadow-md shadow-blue-200"
